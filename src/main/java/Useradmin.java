...
public class Useradmin {
    ...
    @FXML public void NewUserCentralBtnOnAction(ActionEvent event) throws IOException {
        ...
        Stage stage_newuseradmin = (Stage) a.getScene().getWindow();
    ...
    @FXML public void BackUserAdminBtnOnAction(ActionEvent event) throws IOException {
        ...
        Stage stage_backuseradmin = (Stage) b.getScene().getWindow();
    ...
    @FXML public void UserCentralBtnOnAction(ActionEvent event) throws IOException {
        Button c = (Button) event.getSource();
        Stage stage_usercentral = (Stage) c.getScene().getWindow();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("Usercentral.fxml"));
        stage_usercentral.setScene(new Scene(loader.load(), 882, 390));
        stage_usercentral.show();
    }
