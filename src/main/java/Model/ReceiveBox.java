...
public class ReceiveBox {
    ...
    private ArrayList<ReceiveBox> userListBox;
    ...
    public ArrayList<ReceiveBox> getUserListBox() {
        return userListBox;
    }

    public void setUserListBox(ArrayList<ReceiveBox> userListBox) {
        this.userListBox = userListBox;
    }

    public void add(ReceiveBox box){
        userListBox.add(box);
    }

    public ReceiveBox getListByRoomNum(String roomNum) {
        String[] room = roomNum.split(" : ");
        ReceiveBox receiveBoxList = new ReceiveBox();
        for (ReceiveBox box : userListBox) {
